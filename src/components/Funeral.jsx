    ...
    <div>
      ...
      <table className="tabla" ref={tablaRef}>
        <thead>
          ...
          <tr>
            <th className="encabezado">cortejo funebre</th>
          </tr>
          <tr>
        ...
        <tfoot>
          <tr>
            <td className="tips">
              ☝ Favor de informar a los grupos si la vialidad continua cerrada
              o ya hay paso.
            </td>
          </tr>
          <tr>
            <td className="tips">
              ☝ Favor de informar a los grupos cual es el estado de las vías
              alternas ya que a veces esta muy complicado transitar por las vías
              alternas.
            </td>
          </tr>
        </tfoot>
