  ...
  return (
    <div>
      ...
      <table className="tabla" ref={tablaRef}>
        <thead>
        <tr>
            <td style={{ width: '100px', textAlign: 'center' }} ><img style={{ width: '50%', height: 'auto' }} src="./deslave.png" alt="deslave" /></td>
          </tr>
          <tr>
            <th className="encabezado">deslave</th>
          </tr>
          <tr>
